...
// 加载区域结点配置
Config::load();
//阿里云 短信 （依赖 composer require alibabacloud/client）
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4FhmafFhmyWZcipMRiqU"; // AccessKeyId

        $accessKeySecret = "0aShtwoFEdwYtt5F4Tyb1txrhEIpXt"; // AccessKeySecret
...
//        $request->setSignName("春风二里");
        $request->setSignName($param['singName']);

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
//        $request->setTemplateCode("SMS_186946117");
