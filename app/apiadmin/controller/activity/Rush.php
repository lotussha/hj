...
class Rush extends Base
{
    ...
    public function info(ActivityLogic $logic)
    {
        ...
        $this->param['g_field'] = 'goods_id, key, key_name, price, original_price, rush_price, sales_price, cost_price, profits_percent, store_count, spec_img, limited_quantity';
        $validate               = new activityValidate();
